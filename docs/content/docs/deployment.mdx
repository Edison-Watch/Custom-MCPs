...
`edisonmcps-serve` runs the FastAPI app, which mounts FastMCP at `/mcp`. One image,
...
<Cards>
  ...
  <Card
    ...
    href="https://render.com/deploy?repo=https://github.com/Edison-Watch/Custom-MCPs"
...
The committed [`railway.json`](https://github.com/Edison-Watch/Custom-MCPs/blob/main/railway.json)
...
Driven by [`render.yaml`](https://github.com/Edison-Watch/Custom-MCPs/blob/main/render.yaml).
...
See [`.env.example`](https://github.com/Edison-Watch/Custom-MCPs/blob/main/.env.example)
